...
export default function SiteFooter() {
  return <footer className="bg-ink py-14 text-white sm:py-20"><div className="shell">
    ...
    <div className="mt-14 flex flex-col items-center gap-3 border-t border-zinc-800 pt-7 text-center text-sm leading-6 text-zinc-500 sm:mt-20 sm:flex-row sm:flex-wrap sm:justify-between sm:gap-5 sm:text-left"><span>© 2026 Tabflux Academy</span><span>Built with love for the students.</span><span>Privacy · Terms</span></div>
  </div></footer>;
}
